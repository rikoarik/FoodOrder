...
import com.project.foodorder.Adapters.OrderDetailsRecyclerAdapter;
...
public class OrderDetails extends AppCompatActivity {
    ...
    private void insertItems (){
        ...
        //Set total
        ((TextView)findViewById(R.id.order_det_tot1)).setText("Rp "+item.getTotPrice());
        ((TextView)findViewById(R.id.order_det_tot)).setText("Rp "+item.getTotPrice());
        //Set customer addr
